...
public class InsertImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SQliteHelper sqlHelper = new SQliteHelper(InsertImage.this);
                ...
                sqlHelper.insertdata(imageDataStoreg);
                startActivity(new Intent(InsertImage.this, MainActivity.class));
                finish();
            }
        });
    }
    ...
    public void getId() {
        ...
        btnInsert=(Button)findViewById(R.id.insertdata);
        btnGetPhot=(Button)findViewById(R.id.GetPhoto);
        imageView=(ImageView)findViewById(R.id.ImageView);
    }
    private void selectImge(){
        final CharSequence[] items = {"Take Photo", "Choose from Gallary", "Cancel"};

        AlertDialog.Builder builder = new AlertDialog.Builder(InsertImage.this);
